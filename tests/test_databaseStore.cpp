...
TEST_CASE("Reading Known Data - Name from any", "[Database]"){
  databaseStore theDB{"./InputData/KnownDatabaseO.db", true};
  auto id = proIds::Uuid("{cc467402-acd5-494f-9c58-466f3aa6f117}");
  REQUIRE(theDB.fetchNameFromAny(id) == "Project Alpha");
  id = proIds::Uuid("{6364fcb1-6a15-4b69-8412-7ef0eee6c94f}");
  REQUIRE(theDB.fetchNameFromAny(id) == "Documentation"); 
  id = proIds::Uuid("{d74a08d4-35b4-4b7a-b525-b5da00af6269}");
  REQUIRE(theDB.fetchNameFromAny(id) == "Urgent Bugs");
...
TEST_CASE("List fetch - projects w zero FTE", "[Database]"){
  databaseStore theDB{"./InputData/KnownDatabaseZero.db", true};
  auto id = proIds::Uuid("{cc467402-acd5-494f-9c58-466f3aa6f117}");
  auto id2 = proIds::Uuid("{8af5d44a-2921-4666-b33b-053459e2ced6}");
